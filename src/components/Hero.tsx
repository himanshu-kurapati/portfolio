...
const Hero: React.FC = () => {
    ...
    useEffect(() => {
        const handleMouseMove = (e: MouseEvent) => {
            // Track mouse relative to the viewport for the entire hero section
            setMousePosition({
                x: e.clientX,
                y: e.clientY
            });
        ...
        // Add event listener to the entire document to ensure global tracking
    ...
    return (
        ...
        >
            {/* Page-wide spotlight that follows mouse - Behind all elements - Only when mouse is on screen */}
            {isMouseOnScreen && (
                <div
                    ...
                    <div className="flex-1 space-y-8 flex flex-col justify-center lg:pr-8">
                        ...
                        >
                            ...
                            <div className="flex items-baseline space-x-4">
                                <span className="text-3xl lg:text-4xl font-medium text-gray-300">I'm a</span>
